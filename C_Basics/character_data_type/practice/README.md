Date:16-06-2023             TOPIC:character data type
...
7) read a 4 digit number into an integer variable and print it in the following formats using escape sequences.
 Assume the user enters only 4 digit number as input. Reading 4 digits into 4 separate variables is not allowed.
